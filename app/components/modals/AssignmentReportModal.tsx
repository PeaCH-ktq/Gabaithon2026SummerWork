...
export function AssignmentReportModal({
  ...
  taskTitle: string;
  initial?: AssignmentReport;
  sharedWithGroup: boolean;
  saving?: boolean;
  onClose: () => void;
  onSave: (report: AssignmentReport) => void;
}) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2>課題の結果を投稿</h2>
        <p className="report-task-name">{taskTitle}</p>
        ...
        <label className="text-field">
          ...
          <textarea
            ...
            placeholder="難しかった点や、進め方のコツを共有しましょう"
          />
        ...
        <div className="modal-actions">
          <Button subtle onClick={onClose} disabled={saving}>
            キャンセル
          </Button>
          <Button primary icon="share" onClick={submit} disabled={saving}>
            {initial ? "変更を保存" : "結果を投稿"}
          </Button>
        </div>
      </section>
